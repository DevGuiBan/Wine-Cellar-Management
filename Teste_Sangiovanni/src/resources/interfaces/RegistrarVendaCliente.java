 ...
 * @author rafaj
 */
public class RegistrarVendaCliente extends javax.swing.JFrame {

    /**
     * Creates new form CadastrarProduto
     */
    public RegistrarVendaCliente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Adicionar Novo Cliente");
        ...
        jButton8.setForeground(new java.awt.Color(128, 0, 32));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarVendaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarVendaCliente().setVisible(true);
            }
        });
    }
