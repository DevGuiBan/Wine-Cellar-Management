...
public class ListarProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/images/criar.png")))); // NOI18N
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/resources/images/filter.png")))); // NOI18N
    ...
    public void getProduct(){
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Erro ao carregar os produtos: " + responseCode);
                connection.disconnect();
            }
        } catch (Exception e) {
...
class ButtonRendererProduct extends JPanel implements TableCellRenderer {
    ...
    public ButtonRendererProduct() {
        ...
        this.editButton.setBackground(null);
...
class ButtonEditorProduct extends AbstractCellEditor implements TableCellEditor {
    ...
    public ButtonEditorProduct(JTable table,JRootPane rootPane,String APIURL) {
        ...
        editButton.addActionListener(evt -> {
            Object cellValue = table.getValueAt(0,0);
        ...
        {
            int confirmation = JOptionPane.showConfirmDialog(table, "Deseja excluir este produto?", "Confirmação", JOptionPane.YES_NO_OPTION);
            if (confirmation == JOptionPane.YES_OPTION) {
                try{
                    ...
                    if(responseCode==HttpURLConnection.HTTP_NO_CONTENT || responseCode == HttpURLConnection.HTTP_OK){
                        ...
                        JOptionPane.showMessageDialog(this.frame,"Produto Excluido com sucesso!");
                    }
                    else{
                        JOptionPane.showMessageDialog(this.frame,"Ocorreu um erro no servidor!");
                    }
                } catch (Exception ex) {
