...
class ButtonEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public ButtonEditor(JTable table,JRootPane rootPane,String APIURL) {
        ...
        deleteButton.addActionListener(e -> {
            int confirmation = JOptionPane.showConfirmDialog(table, "Deseja excluir este fornecedor?", "Confirmação", JOptionPane.YES_NO_OPTION);
            if (confirmation == JOptionPane.YES_OPTION) {
                try{
                    ...
                    if(responseCode==HttpURLConnection.HTTP_NO_CONTENT || responseCode == HttpURLConnection.HTTP_OK){
                        ...
                        JOptionPane.showMessageDialog(this.frame,"Fornecedor Excluido com sucesso!");
                    }
                    else{
