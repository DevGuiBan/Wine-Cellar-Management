    ...
    private void getProduct()  {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                jSpinner1.setValue(price);
                jSpinner2.setValue(quantity);

                for (int i = 0; i < jComboBox1.getItemCount(); i++) {
                    Supplier sup_in = jComboBox1.getItemAt(i);
                ...
                for (int i = 0; i < jComboBox3.getItemCount(); i++) {
                    ProductType prodType_in = jComboBox3.getItemAt(i);
                ...
                JOptionPane.showMessageDialog(rootPane, "Erro ao carregar o produto: " + responseCode);
                connection.disconnect();
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (statusCode >= 200 && statusCode <= 300) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Ocorreu um erro ao atualizar o produto " + response.toString());
                connection.disconnect();
            }
